...
const schema = zod.object({
  ...
  email: zod.string().min(1, { message: 'Se require correo electronico' }).email(),
  password: zod.string().min(6, { message: 'Contraseña dene tener al menos 6 caracteres' }),
          ...
          <Controller
            ...
            render={({ field }) => (
              <FormControl error={Boolean(errors.email)}>
                <InputLabel>Correo electronico de Tair</InputLabel>
